<div class="booking-wrapper">
    <div class="container">
        <div class="tour-inner clearfix form-inline justify-content-center">
            <div class="form1 clearfix d-flex align-items-center w-100 gap-4">
                <div class="col1 c1 flex-grow-1">
                ...
                <div class="col1 c2">
                    <div class="select1_wrapper">
                        ...
                        <div class="select1_inner">
                            <select wire:model.live="destination" class="select2 select" style="width: 200px">
                ...
                <div class="col1 c4">
                    <div class="select1_wrapper">
                        ...
                        <div class="select1_inner">
                            <select wire:model.live="duration" class="select2 select" style="width: 200px">
...
<style>
/* Thêm một số CSS để đảm bảo layout */
.form1 {
    display: flex;
    align-items: center;
    gap: 20px;
