                ...
                <div class="success-card text-center">
                    ...
                    <div class="booking-details">
                        <div class="detail-item">
                            ...
                            <span class="value">#{{ $pendingBooking->reference_code }}</span>
                        </div>
                        <div class="detail-item">
                            <span class="label">Tour:</span>
                            <span class="value">{{ $pendingBooking->tour->name }}</span>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item total">
                            ...
                            <span class="value">{{ $pendingBooking->formatted_amount }}</span>
                        </div>
                    </div>

                    <div class="success-actions">
                        <a href="{{ route('frontend.booking.history') }}" class="btn btn-outline-primary">
