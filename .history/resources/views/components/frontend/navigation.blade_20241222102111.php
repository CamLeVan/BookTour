    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = async function (e) {
            ...
            try {
                ...
                if (!response.ok) {
                    throw new Error('Có lỗi xảy ra khi tải ảnh lên!');
                }
                ...
                if (data.status === 'success') {
                    ...
                    toastr.error(data.message || 'Cập nhật không thành công!');
                }
            } catch (error) {
...
async function handleFormSubmit(form, actionUrl, successCallback) {
    ...
    try {
        ...
        if (response.ok && data.success) {
            ...
            errorDiv.html('Thông tin không chính xác. Vui lòng kiểm tra lại.').show();
        } else {
