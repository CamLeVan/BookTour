            ...
            @auth
                ...
                <div class="modal-body p-4">
                    ...
                    <form method="post" action="{{ route('profile.update') }}" class="mb-4" id="updateProfileForm">
                        ...
                        <div class="alert alert-success d-none" id="profileUpdateSuccess"></div>
                        <div class="alert alert-danger d-none" id="profileUpdateError"></div>
...
$(document).ready(function() {
    $('#updateProfileForm').on('submit', function(e) {
        ...
        $('#profileUpdateSuccess, #profileUpdateError').addClass('d-none');
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#profileUpdateSuccess').removeClass('d-none').text('Profile updated successfully');
            ...
            error: function(xhr) {
                if (xhr.status === 422) {
                    ...
                    $('#profileUpdateError').removeClass('d-none')
