    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header border-0 position-relative bg-gradient">
                ...
                <h5 class="modal-title position-relative text-dark fw-bold">Welcome Back!</h5>
            ...
            <div class="modal-body p-4">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Sign in to continue to HC Travel</p>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary w-100 py-2 mb-3 btn-elevated">
                        <i class="fas fa-sign-in-alt me-2"></i>Sign In
                    </button>

                    <div class="text-center">
                        <p class="text-muted">Don't have an account? 
                            <a href="#" data-bs-toggle="modal" data-bs-target="#registerModal" class="text-primary fw-bold">
                                Sign Up
                            </a>
                        </p>
                    </div>
