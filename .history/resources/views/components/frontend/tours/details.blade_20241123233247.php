                            ...
                            <form action="{{ route('frontend.tours.booking', $tour) }}" method="POST">
                                ...
                                <div class="row">
                                    @auth
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label>Ghi chú</label>
                                            <textarea name="notes" rows="4" placeholder="Yêu cầu đặc biệt...">{{ old('notes') }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <div class="payment-methods">
                                                <div class="payment-method">
                                                    <input type="radio" name="payment_method" value="direct" id="direct" 
                                                        {{ old('payment_method') == 'direct' ? 'checked' : '' }}>
