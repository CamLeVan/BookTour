                ...
                <div class="sidebar">
                    <div class="right-sidebar">
                        <div class="right-sidebar item">
                            ...
                            <form method="POST" action="{{ route('frontend.tours.booking', $tour) }}" class="right-sidebar item-form">
                                @csrf
                                <div class="row">
                                    @guest
                                        <div class="col-md-12">
                                    ...
                                    @else
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input name="adults" type="number" min="1" value="1" required>
                                        </div>
                                        ...
                                        <div class="col-md-12 form-group">
                                            <label>Ghi chú</label>
                                            <textarea name="notes" rows="4" placeholder="Yêu cầu đặc biệt..."></textarea>
                                        </div>
