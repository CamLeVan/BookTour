                                ...
                                <div class="row">
                                    ...
                                    @else
                                        ...
                                        <div class="col-md-12 form-group input1_inner">
                                            <input type="text" class="form-control input datepicker" name="booking_date" placeholder="Travel Date" required>
                                        </div>

                                        <div class="col-md-12 form-group">
                                            <input name="number_of_people" type="text" placeholder="People" required>
                                        </div>

                                        <div class="col-md-12 form-group">
                                            <textarea name="notes" id="message" cols="30" rows="4" placeholder="Your Enquiry"></textarea>
                                        </div>
