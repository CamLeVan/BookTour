    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="navbar-nav ms-auto">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link" href="#" x-data @click="$dispatch('open-modal', 'login')">Login</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" x-data @click="$dispatch('open-modal', 'register')">Register</a>
                    </li>
                @endauth
            </ul>
        </div>
...
<div x-data="{ 
    ...
    @open-modal.window="activeModal = $event.detail; open = true"
    @close-modal.window="open = false"
    @keydown.escape.window="open = false">

    <!-- Login Modal -->
    <template x-if="activeModal === 'login'">
        <div x-show="open" 
    ...
    <!-- Register Modal -->
    <template x-if="activeModal === 'register'">
        <div x-show="open" 
            class="modal fade show" 
            style="display: block;"
            role="dialog"
