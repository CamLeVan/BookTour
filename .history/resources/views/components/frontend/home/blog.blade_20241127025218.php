<section class="blog section-padding bg-navy">
    <div class="container">
        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="item">
                <div class="position-re o-hidden" style="height: 300px;">
                    <img src="{{ asset('frontend/img/blog/' . $post->image) }}" alt="{{ $post->title }}" style="width: 100%; height: 100%; object-fit: cover;">
                    <div class="date">
