                    ...
                    <form method="POST" action="{{ route('profile.update') }}">
                        ...
                        <div class="text-center mb-4">
                            <div class="avatar-upload mb-3 position-relative">
                                <img src="{{ Auth::user()->avatar_url ? asset(Auth::user()->avatar_url) : asset('frontend/img/user-avatar.png') }}" 
                                     alt="{{ Auth::user()->name }}" 
    ...
    if (file) {
        ...
        .then(data => {
            if (data.success) {
                ...
                const avatarImg = e.target.parentElement.parentElement.querySelector('img');
