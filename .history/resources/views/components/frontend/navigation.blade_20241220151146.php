            ...
            <div class="modal-body p-4">
                <form method="POST" action="{{ route('password.email') }}" id="forgotPasswordForm">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Nhập email của bạn để nh��n link đặt lại mật khẩu</p>
                    </div>
...
<style>
    ...
    .custom-input-group .form-control {
        ...
        border: 2px solid rgba(0, 123, 255, 0.1);
        box-shadow: 0 2px 4px rgba(0, 123, 255, 0.02);
    }
    ...
    .custom-input-group .form-control:focus {
        ...
        box-shadow: 
            ...
            0 8px 16px rgba(0, 123, 255, 0.05);
    }
    ...
    .login-btn:hover {
        background: linear-gradient(45deg, #0066ff, #0095ff);
        box-shadow: 
