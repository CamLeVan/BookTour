                ...
                <div class="card-body">
                    <ul class="list-group custom-group">
                        <li class="list-group-item align-items-center d-flex justify-content-between">
                            <div class="product-list">
                                <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3"
                                    src="{{ asset('images/tours/1.jpg') }}" alt="ảnh-tour" />

                                <div class="product-body align-self-center">
                                    <h6 class="m-0 fw-semibold">Tour Hạ Long</h6>
                                    <p class="mb-0 mt-1 text-muted">Du lịch</p>
                                </div>
                            </div>

                            <div class="product-price">
                                <h6 class="m-0 fw-semibold">990.000đ</h6>
                                <p class="mb-0 mt-1 text-muted">10 Đã bán</p>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item align-items-center d-flex justify-content-between">
                            <div class="product-list">
                                <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3"
                                    src="{{ asset('images/tours/2.jpg') }}" alt="ảnh-tour" />

                                <div class="product-body align-self-center">
                                    <h6 class="m-0 fw-semibold">Tour Phú Quốc</h6>
                                    <p class="mb-0 mt-1 text-muted">Du lịch</p>
                                </div>
                            </div>
                        ...
                        <li class="list-group-item align-items-center d-flex justify-content-between">
                            <div class="product-list">
                                <img class="avatar-md p-1 rounded-circle bg-primary-subtle img-fluid me-3"
                                    src="{{ asset('images/tours/3.jpg') }}" alt="ảnh-tour" />

                                <div class="product-body align-self-center">
                                    <h6 class="m-0 fw-semibold">Tour Đà Nẵng</h6>
                                    <p class="mb-0 mt-1 text-muted">Du lịch</p>
                                </div>
                            </div>
