...
class BookingController extends Controller
{
    ...
    public function store(Tour $tour)
    {
        ...
        try {
            ...
            // Debug booking data trước khi save
            Log::info('Booking Data Before Save:', ['booking' => $booking->toArray()]);
            ...
            try {
                ...
                // Không return lỗi email, chỉ log lại
            }
            ...
            Log::error('Booking Error Stack: ' . $e->getTraceAsString());
