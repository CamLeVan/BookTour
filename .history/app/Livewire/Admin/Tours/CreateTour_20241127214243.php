...
class CreateTour extends Component
{
    ...
    public function createTour()
    {
        ...
        try {
            ...
            $this->image->storeAs('frontend/img/tours', $mainImageName, 'public');
            ...
            if (!empty($this->images)) {
                foreach ($this->images as $item) {
                    ...
                    $item->storeAs('frontend/img/gallery', $galleryName, 'public');
                    $galleryPaths[] = 'frontend/img/gallery/' . $galleryName;
                }
            }
            ...
            Tour::create([
                ...
                'image' => $mainImagePath,
                'gallery' => $gallery, // Đổi tên field từ 'images' thành 'gallery'
                'status' => $this->status,
