...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    // Giữ nguyên các routes hiện có
});

// Spadmin Routes
Route::middleware(['auth', 'spadmin'])->prefix('spadmin')->name('spadmin.')->group(function () {
    Route::get('/dashboard', [App\Http\Controllers\Spadmin\DashboardController::class, 'index'])->name('dashboard');
    // Các routes khác...
});