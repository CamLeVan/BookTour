...
Route::middleware(['web', \App\Http\Middleware\CheckFrontend::class])
    ...
    ->group(function () {
        ...
        Route::middleware(['auth'])->group(function () {
            ...
            // My bookings
            Route::get('/my-bookings', [TourController::class, 'myBookings'])
                ->name('tours.my-bookings');

            Route::post('/bookings/{booking}/process-payment', [TourController::class, 'processPayment'])
