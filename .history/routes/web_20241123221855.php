...
Route::middleware(['web', \App\Http\Middleware\CheckFrontend::class])
    ...
    ->group(function () {
        ...
        Route::middleware(['auth'])->group(function () {
            ...
            // Thêm các routes này vào group auth
            Route::get('/bookings/vnpay/return', [TourController::class, 'vnPayReturn'])->name('bookings.vnpay.return');
            Route::get('/bookings/success/{booking}', [TourController::class, 'success'])->name('bookings.success');
            Route::get('/bookings/failed', [TourController::class, 'failed'])->name('bookings.failed');
        });
    });
...
Route::group(['prefix' => 'bookings', 'as' => 'frontend.bookings.'], function () {
    Route::get('/vnpay/return', [TourController::class, 'vnPayReturn'])->name('vnpay.return');
    Route::get('/success/{booking}', [TourController::class, 'success'])->name('success');
