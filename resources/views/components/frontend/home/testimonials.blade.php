                ...
                <div class="col-md-5 mb-30 mt-30">
                    ...
                    <div class="phone-call mb-10">
                        ...
                        <div class="text">
                            ...
                            <a class="color-1" href="tel:0123456789">0121 121 212</a>
                        </div>
                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="info">
                                    <div class="author-img"> 
                                        @php
                                            // Mảng các avatar mặc định
                                            $defaultAvatars = [
                                                'frontend/img/team/04.png',
                                                'frontend/img/team/05.png', 
                                                'frontend/img/team/06.png'
                                            ];
                                            // Lấy ngẫu nhiên 1 avatar từ mảng
                                            $randomAvatar = $defaultAvatars[array_rand($defaultAvatars)];
                                        @endphp
                                        <img src="{{ asset($randomAvatar) }}" alt="">
                                    </div>
                                    <div class="cont">
                                        <div class="rating"> 
                                            @for($i = 1; $i <= 5; $i++)
